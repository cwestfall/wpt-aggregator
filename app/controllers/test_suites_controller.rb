class TestSuitesController < ApplicationController
  before_action :set_test_suite, only: [:show, :edit, :update, :destroy, :execute]
  ...
  # EXECUTE /test_suites/1/execute
  def execute
    @test_suite.web_test.each do |web_test|
      web_test.execute
    end

    redirect_to @test_suite, notice: 'The execution of your suite has started.'
  end
  ...
  private
    ...
    def test_suite_params
      params.require(:test_suite).permit(:label)
    end
end
